    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-horizontal bordered-row">
                ...
                <button class="btn btn-sm btn-black" data-toggle="modal" data-target="#search_customers"><i
                            class="glyph-icon icon-edit"></i> Editar Vários Clientes
                </button>
            </div>
            <br class="clearfix">
            ...
            <div class="modal fade" id="search_customers" tabindex="-1" role="dialog"
                 aria-labelledby="search_customerslabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Editar Múltiplos Clientes</h4>
                        </div>
                        <form class="form-horizontal bordered-row" method="POST"
                              action="{{ route('customers.edit-multiple') }}">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Adicionar Cliente:</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="customer_email"
                                                   name="customer_email">
                                            <span class="input-group-btn">
                                                    <button class="btn btn-black" type="button" id="add">
                                                         <i class="glyph-icon icon-plus"></i>
                                                    </button>
                                                </span>
                                        </div>
                                        Clique no item para remover da pesquisa.
                                    </div>
                                    <div class="col-sm-">
                                        <select multiple class="multi-select" name="customers[]" id="customers_search"
                                                readonly>
                                        </select>
                                    </div>
                                </div>
