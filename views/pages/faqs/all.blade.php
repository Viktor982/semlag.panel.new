                    ...
                    @foreach($faqs as $faq)
                        <tr>
                            ...
                            <td>
                                <div class="col-md-9">
                                    <form method="post"
                                          action="{{ route('site.faqs-update-order', ['id' => $faq->id ]) }}">
                            ...
                            <td>{{ $faq->question }}</td>
                            <td>
                                {!! aroute('<i class="glyph-icon icon-edit"></i> Editar</a>', 'site.faqs-edit', ['id' => $faq->id], ['class' => 'btn btn-sm btn-black'])!!}
                                {!! aroute('<i class="glyph-icon icon-remove"></i> Deletar</a>', 'site.faqs-delete', ['id' => $faq->id], ['class' => 'btn btn-sm btn-danger'])!!}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
